...
from navsim.agents.diffusiondrive.transfuser_model_v2 import AgentHead
from torch.nn import TransformerDecoder,TransformerDecoderLayer
from typing import Any, List, Dict, Optional, Union


class TransfuserMFModel(nn.Module):
...
class TrajectoryMFHead(nn.Module):
    ...
    def __init__(self, num_poses: int, d_ffn: int, d_model: int, config: TransfuserConfig):
        ...
        """
        super(TrajectoryMFHead, self).__init__()
